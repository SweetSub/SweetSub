...
for dir in changed_dir:
    ...
    for file in dir.iterdir():
        ...
        if m:
            ...
            table.append(Episode(ep, ep_title, f"https://raw.githubusercontent.com/SweetSub/SweetSub/master/{fname}.chs.ass",f"https://raw.githubusercontent.com/SweetSub/SweetSub/master/{fname}.cht.ass"))
            table.sort(key=lambda x:x.ep)

    # make it string
    table_content = []
    for e in table:
        table_content.append(f"| {e.ep} | {e.ep_title} | [简体]({e.chs}) | [繁体]({e.cht}) |")
